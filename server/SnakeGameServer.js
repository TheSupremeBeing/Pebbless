...
var SnakeGameServer = 
{
	...
	{	
		...
		{	
		    ...
		    console.log("===== CONNECTION ON".blue);
		...
		if(data.type === "utf8")
		{
			...
			switch(content.type.id)
			{
				case SnakeMessage.TYPES.MOVE.id:
					...
					SnakeGameServer.broadcastMessage(new SnakeMessage(SnakeMessage.TYPES.SCORE, SnakeGameCore.scores), null); //Broadcast to *all* snakes
					break;
			};
		}
	},
